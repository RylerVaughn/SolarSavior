...
//           const { id, geometry, pointCount } = cluster;
//           const coordinates = {
...
//           const size = 40 + Math.min(pointCount, 50) * 0.5; // grows with cluster size

//           return (
//             <Marker
//               key={`cluster-${id}`}
//               coordinate={coordinates}
//               anchor={{ x: 0.5, y: 0.5 }} // center the cluster properly
...
//                   height: size,
//                   borderRadius: size / 2,
//                   backgroundColor: pointCount > 10 ? "#FF3B30" : "#007AFF",
...
//                     color: "#fff",
//                     fontWeight: "bold",
//                     fontSize: 14 + Math.min(pointCount, 20) * 0.3,
//                   }}
//                 >
//                   {pointCount}
//                 </Text>
...
//   }}
// >
//   <Marker coordinate={{ latitude: 34.42, longitude: -119.7 }} />
//   <Marker coordinate={{ latitude: 34.43, longitude: -119.71 }} />
//   <Marker coordinate={{ latitude: 34.44, longitude: -119.72 }} />
// </MapView>
...
// TestClusterMap.js
import ClusterMap from "@gorhom/cluster-map";
import { Marker } from "react-native-maps";

function App() {
  const markers = [
    { id: 1, latitude: 34.42, longitude: -119.7 },
    { id: 2, latitude: 34.43, longitude: -119.71 },
    // more…
  ];
